...
export function App() {
  ...
  const coords: Coordinates | null =
    ...
    (geo.status === 'success' ? geo.coords : null)
  ...
  }, [manualLocation?.coords.lat, manualLocation?.coords.lon]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(180deg, #000d1a 0%, #001433 60%, #000d1a 100%)',
      }}
    >
      {/* Header bar */}
      ...
      <div className="flex flex-1 overflow-hidden">
        {showLocationSearch ? (
          ...
          <>
            ...
            {/* Divider */}
            <div style={{ width: '2px', background: 'linear-gradient(180deg, #1a4070 0%, #003366 50%, #1a4070 100%)' }} />
      ...
      {data && isLoading && (
        <div
          ...
          style={{ background: 'rgba(0,0,0,0.6)', color: '#557799', border: '1px solid #1a4070' }}
        >
          Updating...
        </div>
      )}
  ...
  return (
    <div className="flex flex-col items-center justify-center flex-1 gap-4">
      ...
      <button
        ...
        style={{ background: '#003366', color: '#00aaff', border: '1px solid #0055a0' }}
      >
        Retry
      </button>
    </div>
