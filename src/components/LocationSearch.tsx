...
export function LocationSearch({ onLocationFound }: Props) {
  ...
  return (
    <div
      ...
      style={{ background: 'linear-gradient(180deg, #000d1a 0%, #001433 100%)' }}
    >
      <div
      ...
      <div className="text-sm text-center" style={{ color: '#557799', maxWidth: '22rem' }}>
        Location access was denied or unavailable.<br />Enter a city name or zip code to get started.
      </div>
      ...
      {error && (
        <div className="text-xs" style={{ color: '#ff8800' }}>{error}</div>
      )}
    </div>
  )
}
